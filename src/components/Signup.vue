...
export default {
  ...
  methods: {
    async onLogin() {
      ...
      // let encrypted = encrypt.encrypt(this.form.pass);
      // console.log(encrypted)

      // const key = new NodeRSA(publicKey); // , 'public', {b: 256});
      // // key.importKey(publicKey, 'pkcs8');
      // const encrypted = key.encrypt(this.form.pass, 'base64', "");
      // console.log('encrypted: ', encrypted);

      var pki = forge.pki;
      var pk = pki.publicKeyFromPem(publicKey);
      var encrypted = pk.encrypt("test@123", 'RSA-OAEP', {
